...
db = URI.parse(ENV['DATABASE_URL'] || "postgres://yywtyltg:gY_ZhJ62ET5sbaq2bLQgZwh4fCSCEYU2@qdjjtnkv.db.elephantsql.com:5432/yywtyltg" || "postgres://localhost/#{APP_NAME}_#{Sinatra::Application.environment}")
